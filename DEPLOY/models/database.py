...
class Answers(db.Model):
    ...
    qn_id = db.Column(db.Integer, db.ForeignKey('question.qn_id'), nullable=False)
    selected_option_id = db.Column(db.Integer, db.ForeignKey('options.option_id'), nullable=True)
